...
define("APPLICATION_ENV", "development"); //necessary for debug.php
	...
	// Code Table:  Title
	// Database Table Name: SUFFIXCODE
	...
	try {
      ...
      $req = array(
          ...
          'CodeTableName'   => 'SUFFIXCODE', // the name of the code table in the db
  ...
  <html>
	...
	<div class="navbar">
        <div class="navbar-inner">
            <a class="brand" href="#">Code Table: SUFFIXCODE</a>
        </div>
    </div>
